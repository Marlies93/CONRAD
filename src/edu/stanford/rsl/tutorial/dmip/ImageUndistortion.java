...
public class ImageUndistortion{
	...
	public void doImageUndstortion(){
		...
		int caseNo = 0;
		String filename = "/proj/i5dmip/qe21vady/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/frame32.jpg";
		
		
		if(caseNo == 0)
		{
			filename = "/proj/i5dmip/qe21vady/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/frame32.jpg";
		}
		else if(caseNo == 1)
		{
			filename = "/proj/i5dmip/qe21vady/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/undistorted.jpg";
		}else if(caseNo == 2)
		{
			filename = "/proj/i5dmip/qe21vady/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/frame90.jpg";
		}
		...
		Yd2.multiplyBy(-1);
		Xd2.add(Xu2,Xu2);
		Yd2.add(Yu2,Yu2); //pointwise addition
